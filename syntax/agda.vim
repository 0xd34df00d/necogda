...
hi def link agdaVMGoal           CocWarningSign
hi def link agdaVMWarning        CocWarningSign
hi def link agdaVMError          CocErrorSign
hi def      agdaItalic           cterm=underline
...
hi def link agda_atom_inductiveconstructor Function
hi def link agda_atom_coinductiveconstructor Function
hi def link agda_atom_datatype Type
hi def link agda_atom_field Identifier
...
hi def link agda_atom_primitive Special
